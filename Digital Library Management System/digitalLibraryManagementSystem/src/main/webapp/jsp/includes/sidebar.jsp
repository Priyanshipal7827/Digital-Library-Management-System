...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
    <div class="position-sticky sidebar-sticky">
        <ul class="nav flex-column">
            ...
            <li class="nav-item"><a class="nav-link" href="BookController?action=showFines"><i class="bi bi-cash-coin"></i>Fines</a></li>
            <li class="nav-item"><a class="nav-link" href="ContactController?action=showContactForm"><i class="bi bi-envelope"></i>Contact Us</a></li>
            <li class="nav-item"><a class="nav-link" href="AuthController?action=logout"><i class="bi bi-box-arrow-right"></i>Sign Out</a></li>
        </ul>
    </div>
</nav>